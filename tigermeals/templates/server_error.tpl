...
<html lang="en">
  ...
  <head>
    ...
    <title>TigerMeals Delivery - Server Error</title>
        ...
        <div class="row">
          <div class="col align-self-center">
            <div class="py-5 px-5 text-center">
              ...
              <h2>500 Error</h2>
              <p class="lead mb-0">Uh oh! We encountered a server error.</p>
            </div>
            <div class="row px-5 justify-content-center">
                <button class="btn btn-primary" onclick="window.location.href='/home';"><strong>Go back home</strong></button>
            </div>
